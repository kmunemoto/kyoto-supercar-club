  ...
  return (
    <SiteShell>
      <PageIntro
        kicker="TERMS"
        title="利用条件（準備中）"
        lead={`${BRAND.name}（以下「当サービス」）の利用条件は現在整備中です。正式な提供開始前に、適用される法令・許認可・保険条件を確認し、確定した利用条件を公開します。`}
      />
      <Section className="max-w-3xl space-y-8 pt-0">
        <p className="text-ink-soft">{LEGAL_BANNER}</p>
        <p className="text-ink-soft">
          当サービスのフォーム送信は、相談または興味登録の意思表示であり、契約の成立ではありません。
        </p>
        <ul className="space-y-3 text-ink-soft">
          <li>COLLECTIONは、プロジェクト参加者が購入資金を出し、共有持分を持つ共同所有です。</li>
          <li>
            REGISTRYは、所有権と保管を元のオーナーに残した無料の登録制です。車両の貸し借りは行いません。
          </li>
          <li>
            運転は登録された運転者のみ。又貸し、サーキット、ドリフト、危険運転を禁じる方針です。
          </li>
        </ul>
        <p className="text-sm text-muted">
          事故や損傷が発生した場合の負担、禁止事項、保証金の取扱いは、正式募集時の契約条件で明示します。概要は安全・保険のページをご覧ください。
        </p>
        <p className="text-sm">
