    ...
    <SiteShell>
      ...
      <Section className="max-w-3xl space-y-8 pt-0">
        <p className="text-ink-soft">
          {BRAND.name}
          はサービス準備・検証段階です。車両の予約・貸出・課金・購入申込は行っていません。フォーム送信は相談または興味登録の意思表示であり、契約の成立ではありません。現時点で車両代や参加申込預り金は受け取りません。
        </p>
        <ul className="space-y-3 text-ink-soft">
          ...
          <li>オーナーネットワークは共同所有ではなく、所有権と保管は元のオーナーに残します。他車利用時のみクラス別の保証金があります。登録だけなら保証金はありません。</li>
