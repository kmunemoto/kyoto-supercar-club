    ...
    <SiteShell>
      ...
      <Section>
        ...
        <article className="mt-16 border-t border-line pt-10">
          <h2 className="font-serif text-3xl">事故と運転者負担の方針</h2>
          <p className="mt-4 max-w-3xl text-ink-soft">{ACCIDENT_POLICY}</p>
          <h3 className="mt-10 font-serif text-xl">将来の貸渡約款で検討する運転者負担</h3>
        ...
        <aside className="mt-16 rounded-xl border border-line bg-cream p-6 md:p-8">
          ...
          <p className="mt-3 text-ink-soft">
            保険の補償額、免責金額、保証金、GPS機器のメーカー、整備工場名は未確定です。「保険に入っているので何があっても安心」「事故はすべて運転者が払う」といった断定はしません。管理者向けの確認事項は、運営画面の「要確認」に残しています。
          </p>
        </aside>
      </Section>
    </SiteShell>
