...
export const BRAND = {
  ...
  phaseLabel: "サービス準備中",
  phaseNote:
    "京都を車両の保管・管理・受け渡し拠点として、共同購入とオーナー同士の相互利用を準備しています。いまは先行登録・相談のみで、契約・購入・予約ではありません。",
  region: "京都を車両管理・受け渡し拠点として準備中",
  kyotoDefinition:
    "KSCにおける京都限定とは、会員の住所ではなく、登録車両の保管・管理・受け渡し拠点が京都府内にあることを意味します。",
...
export const OWNER_VALUE =
  "スーパーカー所有者限定。愛車は各オーナーが所有したまま、保管・鍵の受け渡し拠点は京都府内。登録オーナー同士で他の車両を相互利用する仕組みを準備しています";

export const COLLECTION_VALUE =
  "買えないから、分けるのではない。一台に資金と維持費を固定せず、乗りたい車を合理的に所有する。投資商品ではありません。";
